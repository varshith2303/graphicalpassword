        ...
        <div>
            <div className="flex-col md:flex-row flex justify-around mt-8 sm:mt-16 font-['Work_Sans']">
                ...
                <div className="sm:hidden flex justify-center">
                    <img alt="" className="rounded-[25px] w-[90%]" />
                </div>

                {/*INFO*/}
                <div className="text-white ml-8 mt-8 mb-20">
                    <p className="text-3xl sm:text-5xl ">Revolutionize Security with</p>
                    <p className="text-3xl sm:text-7xl font-bold"> Graphical Password Authentication</p>
                    <p className="text-xl sm:text-3xl mt-6">Unlock Security with Visual Simplicity</p>
                    <button onClick={handleKnowMore} className="transition duration-500 ease-in-out sm:w-1/3 bg-[#A27B5C] rounded-lg px-4 py-1 mt-6 sm:text-xl border-[#A27B5C] border-2 hover:bg-transparent">
                ...
                <div className="hidden sm:block">
                    <img alt="" className=" hover:scale-95 transition duration-500 ease-in-out hover:shadow-2xl hover:shadow-[#3F4E4F] rounded-[25px] w-full" />
                </div>
            </div>
